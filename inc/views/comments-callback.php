...
<div id="respond-<?php comment_ID(); ?>" class="each-comment">
	...
	<div class="media-body comments-body">
		<div class="comment-meta">
			...
			?>
			<div class="comment-author-name"><span><?php echo get_comment_author_link( $comment );?></span> <?php printf( esc_html__( '%1$s', 'digeco' ), get_comment_date( '', $comment ) );?></div>			
		</div>
		<div class="comment-text">
			<?php if ( '0' == $comment->comment_approved ) : ?>
				<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'digeco' ); ?></p>
			<?php endif; ?>
			<?php comment_text(); ?>
		</div>			
	</div>
