<?php
$digeco_footer_column = DigecoTheme::$options['footer_column_7'];
...
$digeco_footer7_topshap = empty( DigecoTheme::$options['footer7_top_shape']['url'] ) ? DIGECO_IMG_URL . 'element76.png' : DigecoTheme::$options['footer7_top_shape']['url'];
// Logo
...
<?php if ( DigecoTheme::$footer_area == 1 || DigecoTheme::$footer_area == 'on' ) { ?>
	<img src="<?php echo esc_url($digeco_footer7_topshap); ?>" alt="footershape">
