...
$digeco_header_action  = ( DigecoTheme::$options['search_icon'] || DigecoTheme::$options['cart_icon'] || DigecoTheme::$options['online_button'] == '1' || DigecoTheme::$options['vertical_menu_icon'] && has_nav_menu( 'topright' ) ) ? true : false;
			...
			<div class="menu-right-wrap header-icon-area">
				...
				<div class="header-button-wrap">
					<div class="header-button">
						<a class="button-btn" target="_self" href="<?php echo esc_url( DigecoTheme::$options['online_button_link']  );?>"><?php echo esc_html( DigecoTheme::$options['online_button_text'] );?></a>
					</div>
				</div>
				<?php } ?>
				<?php if ( DigecoTheme::$options['vertical_menu_icon'] && has_nav_menu( 'topright' ) ) { ?>
